  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        >
        <p @click="changeDefaultAddress(addressList, address)">
      ...
      <div class="detail" >
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="(shopList,index) in detailArrayList" :key="index">
          <li>
            <img :src="shopList.imgUrl" alt="" style="width:50px;height:50px">
          </li>
          <li>
            <p>
            {{shopList.skuName}}</p>
          ...
          <li>
            <h3>{{shopList.orderPrice}}</h3>
          </li>
          <li>{{shopList.skuNum}}</li>
          <li>有货</li>
        </ul>
...
import { mapGetters ,mapState} from 'vuex'
  export default {
    ...
    methods: {
      ...
      //排他修改订单信息
      changeDefaultAddress(addressList,address){
    ...
    async  submitOrder(){
      ...
      try {
        const result = await this.$API.reqSubmitList(tradeNo,tradeInfo);
